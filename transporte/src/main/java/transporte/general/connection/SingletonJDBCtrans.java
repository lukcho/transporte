 ...
 *
 */
public class SingletonJDBCtrans {

	private static String URL = "jdbc:postgresql://10.1.0.158:5432/transporte";
	...
	private static SingletonJDBCtrans jdbc;

	private SingletonJDBCtrans() {
	}

	public static SingletonJDBCtrans getInstance() {
		if (jdbc == null) {
			jdbc = new SingletonJDBCtrans();
		}
		return jdbc;
	}
